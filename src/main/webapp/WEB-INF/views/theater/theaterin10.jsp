  ...
  <div align="center" style="margin:10px;">
	...
	<div class="wrap-theater">
		...
		<div class="sect-theater">
			<h4 class="theater-tit"><span>CGV광명역</span></h4>
			<div class="wrap-theaterinfo">
				<div class="box-image">
					<div id="theater_img_container" class="thumb-image">
					<img src="image/cgv10.jpg" alt="CGV광명역 극장">
					</div>
				</div>
				<div class="box-contents">
					<div class="theater-info">
						<strong class="title">
							"경기도 광명시 일직동 514 GIDC B동 지하2층"
							<br>
							"경기도 광명시 일직로 43 GIDC B동 지하2층"
							<a href="http://localhost:8787/ysys/map10#">위치/주차 안내</a>
						</strong>
						<span class="txt-info">
							<em>1544-1122</em>
							<em>5관 / 374석</em>
