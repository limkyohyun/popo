...
<div class="wrap-theater">
		...
		<div class="sect-theater">
			<h4 class="theater-tit"><span>CGV강변</span></h4>
			<div class="wrap-theaterinfo">
				<div class="box-image">
					<div id="theater_img_container" class="thumb-image">
					<img src="image/cgv2.png" alt="CGV강변 극장">
					</div>
				</div>
				<div class="box-contents">
					<div class="theater-info">
						<strong class="title">
							"서울특별시 광진구 구의동 546-4 테크노마트 10층"
							<br>
							"서울특별시 광진구 광나루로56길 85 (구의동)"
							<a href="http://localhost:8787/ysys/map2#">위치/주차 안내</a>
						</strong>
						<span class="txt-info">
							<em>1544-1122</em>
							<em>11관 / 1,466석</em>
