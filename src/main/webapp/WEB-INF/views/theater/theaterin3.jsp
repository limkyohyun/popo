  ...
  <div align="center" style="margin:10px;">
	...
	<div class="wrap-theater">
		...
		<div class="sect-theater">
			<h4 class="theater-tit"><span>CGV구로</span></h4>
			<div class="wrap-theaterinfo">
				<div class="box-image">
					<div id="theater_img_container" class="thumb-image">
					<img src="image/cgv4.jpg" alt="CGV구로 극장">
					</div>
				</div>
				<div class="box-contents">
					<div class="theater-info">
						<strong class="title">
							"서울특별시 구로구 구로5동 573번지 NC신구로점 6층"
							<br>
							"서울특별시 구로구 구로중앙로 152 (구로동)"
							<a href="http://localhost:8787/ysys/map4#">위치/주차 안내</a>
						</strong>
						<span class="txt-info">
							<em>1544-1122</em>
							<em>8관 / 1,232석</em>
