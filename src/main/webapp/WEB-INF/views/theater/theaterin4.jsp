...
<div class="wrap-theater">
		...
		<div class="sect-theater">
			<h4 class="theater-tit"><span>CGV건대입구</span></h4>
			<div class="wrap-theaterinfo">
				<div class="box-image">
					<div id="theater_img_container" class="thumb-image">
					<img src="image/cgv3.jpg" alt="CGV건대입구 극장">
					</div>
				</div>
				<div class="box-contents">
					<div class="theater-info">
						<strong class="title">
							"서울특별시 광진구 자양동 9-4 몰오브케이 3층"
							<br>
							"서울특별시 광진구 아차산로 30길 26 몰오브케이 3층"
							<a href="http://localhost:8787/ysys/map3#">위치/주차 안내</a>
						</strong>
						<span class="txt-info">
							<em>1544-1122</em>
							<em>5관 / 754석</em>
