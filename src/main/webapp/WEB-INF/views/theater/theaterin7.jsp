  ...
  <div align="center" style="margin:10px;">
	...
	<div class="wrap-theater">
		...
		<div class="sect-theater">
			<h4 class="theater-tit"><span>CGV고양행신</span></h4>
			<div class="wrap-theaterinfo">
				<div class="box-image">
					<div id="theater_img_container" class="thumb-image">
					<img src="image/cgv7.jpg" alt="CGV고양행신 극장">
					</div>
				</div>
				<div class="box-contents">
					<div class="theater-info">
						<strong class="title">
							"경기도 고양시 덕양구 행신동 762-2,3 로터스플레이스 5F"
							<br>
							"경기도 고양시 덕양구 충장로 8 로터스플레이스 5F"
							<a href="http://localhost:8787/ysys/map7#">위치/주차 안내</a>
						</strong>
						<span class="txt-info">
							<em>1544-1122</em>
							<em>6관 / 658석</em>
