  ...
  <div align="center" style="margin:10px;">
	...
	<div class="wrap-theater">
		...
		<div class="sect-theater">
			<h4 class="theater-tit"><span>CGV광교상현</span></h4>
			<div class="wrap-theaterinfo">
				<div class="box-image">
					<div id="theater_img_container" class="thumb-image">
					<img src="image/cgv9.jpg" alt="CGV광교상현 극장">
					</div>
				</div>
				<div class="box-contents">
					<div class="theater-info">
						<strong class="title">
							"경기도 용인시 수지구 상현동 1116-4 W스퀘어 2층"
							<br>
							<a href="http://localhost:8787/ysys/map9#">위치/주차 안내</a>
						</strong>
						<span class="txt-info">
							<em>1544-1122</em>
							<em>4관 / 406석</em>
